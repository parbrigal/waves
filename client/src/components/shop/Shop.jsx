...
import CollapseBox from "../elements/CollapseBox";
import CollapseRadio from "../elements/CollapseRadio";
import ShopDisplay from "../elements/ShopDisplay";
import FontAwesomeIcon from '@fortawesome/react-fontawesome';
import faBars from '@fortawesome/fontawesome-free-solid/faBars';
import faTh from '@fortawesome/fontawesome-free-solid/faTh';
import { connect } from "react-redux";
import { frets, price } from "../elements/Form/fixed_categories";
...
class Shop extends Component {
  ...
  showFilteredResults = newFilters => {
    this.props.dispatch(
      getProductsToShop(0, this.state.limit, newFilters)).then(() => {
        this.setState({
          skip: 0
        });
      })
